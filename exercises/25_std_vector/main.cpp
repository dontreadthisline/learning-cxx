...
int main(int argc, char **argv) {
    {
        ...
        ASSERT(sizeof(vec) == 5 * 4, "Fill in the correct value.");
        int ans[]{1, 2, 3, 4, 5};
    ...
    }
    {
        ...
        {
            ASSERT(vec.size() == 5, "Fill in the correct value.");
            ASSERT(sizeof(vec) == 5 * 8, "Fill in the correct value.");
        ...
        }
        {
            ...
            ASSERT(sizeof(vec) == 7 * 8, "Fill in the correct value.");
            vec.pop_back();
            ASSERT(vec.size() == 6, "Fill in the correct value.");
            ASSERT(sizeof(vec) == 6 * 8, "Fill in the correct value.");
        }
        {
            vec[4] = 6;
            ASSERT(vec[0] == 0, "Fill in the correct value.");
            ASSERT(vec[1] == 1, "Fill in the correct value.");
            ASSERT(vec[2] == 2, "Fill in the correct value.");
            ASSERT(vec[3] == 3, "Fill in the correct value.");
            ASSERT(vec[4] == 6, "Fill in the correct value.");
        }
        {
            // THINK: `std::vector` 插入删除的时间复杂度是什么？
            vec.insert(vec.at(1), 1.5);
